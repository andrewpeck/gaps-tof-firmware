...
package registers is
    ...
    constant REG_MT_NUM_REGS : integer := 238;
    ...
    constant REG_MT_FINE_DELAYS_LT0_ADDR    : std_logic_vector(9 downto 0) := "00" & x"60";
    constant REG_MT_FINE_DELAYS_LT0_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT0_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT0_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT1_ADDR    : std_logic_vector(9 downto 0) := "00" & x"61";
    constant REG_MT_FINE_DELAYS_LT1_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT1_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT1_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT2_ADDR    : std_logic_vector(9 downto 0) := "00" & x"62";
    constant REG_MT_FINE_DELAYS_LT2_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT2_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT2_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT3_ADDR    : std_logic_vector(9 downto 0) := "00" & x"63";
    constant REG_MT_FINE_DELAYS_LT3_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT3_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT3_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT4_ADDR    : std_logic_vector(9 downto 0) := "00" & x"64";
    constant REG_MT_FINE_DELAYS_LT4_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT4_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT4_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT5_ADDR    : std_logic_vector(9 downto 0) := "00" & x"65";
    constant REG_MT_FINE_DELAYS_LT5_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT5_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT5_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT6_ADDR    : std_logic_vector(9 downto 0) := "00" & x"66";
    constant REG_MT_FINE_DELAYS_LT6_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT6_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT6_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT7_ADDR    : std_logic_vector(9 downto 0) := "00" & x"67";
    constant REG_MT_FINE_DELAYS_LT7_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT7_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT7_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT8_ADDR    : std_logic_vector(9 downto 0) := "00" & x"68";
    constant REG_MT_FINE_DELAYS_LT8_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT8_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT8_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT9_ADDR    : std_logic_vector(9 downto 0) := "00" & x"69";
    constant REG_MT_FINE_DELAYS_LT9_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT9_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT9_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT10_ADDR    : std_logic_vector(9 downto 0) := "00" & x"6a";
    constant REG_MT_FINE_DELAYS_LT10_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT10_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT10_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT11_ADDR    : std_logic_vector(9 downto 0) := "00" & x"6b";
    constant REG_MT_FINE_DELAYS_LT11_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT11_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT11_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT12_ADDR    : std_logic_vector(9 downto 0) := "00" & x"6c";
    constant REG_MT_FINE_DELAYS_LT12_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT12_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT12_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT13_ADDR    : std_logic_vector(9 downto 0) := "00" & x"6d";
    constant REG_MT_FINE_DELAYS_LT13_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT13_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT13_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT14_ADDR    : std_logic_vector(9 downto 0) := "00" & x"6e";
    constant REG_MT_FINE_DELAYS_LT14_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT14_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT14_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT15_ADDR    : std_logic_vector(9 downto 0) := "00" & x"6f";
    constant REG_MT_FINE_DELAYS_LT15_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT15_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT15_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT16_ADDR    : std_logic_vector(9 downto 0) := "00" & x"70";
    constant REG_MT_FINE_DELAYS_LT16_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT16_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT16_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT17_ADDR    : std_logic_vector(9 downto 0) := "00" & x"71";
    constant REG_MT_FINE_DELAYS_LT17_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT17_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT17_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT18_ADDR    : std_logic_vector(9 downto 0) := "00" & x"72";
    constant REG_MT_FINE_DELAYS_LT18_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT18_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT18_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT19_ADDR    : std_logic_vector(9 downto 0) := "00" & x"73";
    constant REG_MT_FINE_DELAYS_LT19_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT19_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT19_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT20_ADDR    : std_logic_vector(9 downto 0) := "00" & x"74";
    constant REG_MT_FINE_DELAYS_LT20_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT20_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT20_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT21_ADDR    : std_logic_vector(9 downto 0) := "00" & x"75";
    constant REG_MT_FINE_DELAYS_LT21_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT21_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT21_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT22_ADDR    : std_logic_vector(9 downto 0) := "00" & x"76";
    constant REG_MT_FINE_DELAYS_LT22_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT22_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT22_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT23_ADDR    : std_logic_vector(9 downto 0) := "00" & x"77";
    constant REG_MT_FINE_DELAYS_LT23_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT23_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT23_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT24_ADDR    : std_logic_vector(9 downto 0) := "00" & x"78";
    constant REG_MT_FINE_DELAYS_LT24_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT24_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT24_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT25_ADDR    : std_logic_vector(9 downto 0) := "00" & x"79";
    constant REG_MT_FINE_DELAYS_LT25_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT25_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT25_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT26_ADDR    : std_logic_vector(9 downto 0) := "00" & x"7a";
    constant REG_MT_FINE_DELAYS_LT26_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT26_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT26_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT27_ADDR    : std_logic_vector(9 downto 0) := "00" & x"7b";
    constant REG_MT_FINE_DELAYS_LT27_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT27_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT27_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT28_ADDR    : std_logic_vector(9 downto 0) := "00" & x"7c";
    constant REG_MT_FINE_DELAYS_LT28_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT28_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT28_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT29_ADDR    : std_logic_vector(9 downto 0) := "00" & x"7d";
    constant REG_MT_FINE_DELAYS_LT29_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT29_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT29_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT30_ADDR    : std_logic_vector(9 downto 0) := "00" & x"7e";
    constant REG_MT_FINE_DELAYS_LT30_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT30_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT30_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT31_ADDR    : std_logic_vector(9 downto 0) := "00" & x"7f";
    constant REG_MT_FINE_DELAYS_LT31_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT31_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT31_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT32_ADDR    : std_logic_vector(9 downto 0) := "00" & x"80";
    constant REG_MT_FINE_DELAYS_LT32_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT32_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT32_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT33_ADDR    : std_logic_vector(9 downto 0) := "00" & x"81";
    constant REG_MT_FINE_DELAYS_LT33_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT33_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT33_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT34_ADDR    : std_logic_vector(9 downto 0) := "00" & x"82";
    constant REG_MT_FINE_DELAYS_LT34_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT34_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT34_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT35_ADDR    : std_logic_vector(9 downto 0) := "00" & x"83";
    constant REG_MT_FINE_DELAYS_LT35_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT35_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT35_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT36_ADDR    : std_logic_vector(9 downto 0) := "00" & x"84";
    constant REG_MT_FINE_DELAYS_LT36_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT36_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT36_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT37_ADDR    : std_logic_vector(9 downto 0) := "00" & x"85";
    constant REG_MT_FINE_DELAYS_LT37_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT37_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT37_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT38_ADDR    : std_logic_vector(9 downto 0) := "00" & x"86";
    constant REG_MT_FINE_DELAYS_LT38_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT38_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT38_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT39_ADDR    : std_logic_vector(9 downto 0) := "00" & x"87";
    constant REG_MT_FINE_DELAYS_LT39_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT39_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT39_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT40_ADDR    : std_logic_vector(9 downto 0) := "00" & x"88";
    constant REG_MT_FINE_DELAYS_LT40_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT40_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT40_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT41_ADDR    : std_logic_vector(9 downto 0) := "00" & x"89";
    constant REG_MT_FINE_DELAYS_LT41_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT41_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT41_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT42_ADDR    : std_logic_vector(9 downto 0) := "00" & x"8a";
    constant REG_MT_FINE_DELAYS_LT42_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT42_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT42_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT43_ADDR    : std_logic_vector(9 downto 0) := "00" & x"8b";
    constant REG_MT_FINE_DELAYS_LT43_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT43_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT43_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT44_ADDR    : std_logic_vector(9 downto 0) := "00" & x"8c";
    constant REG_MT_FINE_DELAYS_LT44_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT44_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT44_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT45_ADDR    : std_logic_vector(9 downto 0) := "00" & x"8d";
    constant REG_MT_FINE_DELAYS_LT45_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT45_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT45_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT46_ADDR    : std_logic_vector(9 downto 0) := "00" & x"8e";
    constant REG_MT_FINE_DELAYS_LT46_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT46_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT46_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT47_ADDR    : std_logic_vector(9 downto 0) := "00" & x"8f";
    constant REG_MT_FINE_DELAYS_LT47_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT47_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT47_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT48_ADDR    : std_logic_vector(9 downto 0) := "00" & x"90";
    constant REG_MT_FINE_DELAYS_LT48_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT48_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT48_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT49_ADDR    : std_logic_vector(9 downto 0) := "00" & x"91";
    constant REG_MT_FINE_DELAYS_LT49_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT49_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT49_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT50_ADDR    : std_logic_vector(9 downto 0) := "00" & x"92";
    constant REG_MT_FINE_DELAYS_LT50_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT50_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT50_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT51_ADDR    : std_logic_vector(9 downto 0) := "00" & x"93";
    constant REG_MT_FINE_DELAYS_LT51_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT51_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT51_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT52_ADDR    : std_logic_vector(9 downto 0) := "00" & x"94";
    constant REG_MT_FINE_DELAYS_LT52_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT52_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT52_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT53_ADDR    : std_logic_vector(9 downto 0) := "00" & x"95";
    constant REG_MT_FINE_DELAYS_LT53_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT53_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT53_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT54_ADDR    : std_logic_vector(9 downto 0) := "00" & x"96";
    constant REG_MT_FINE_DELAYS_LT54_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT54_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT54_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT55_ADDR    : std_logic_vector(9 downto 0) := "00" & x"97";
    constant REG_MT_FINE_DELAYS_LT55_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT55_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT55_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT56_ADDR    : std_logic_vector(9 downto 0) := "00" & x"98";
    constant REG_MT_FINE_DELAYS_LT56_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT56_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT56_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT57_ADDR    : std_logic_vector(9 downto 0) := "00" & x"99";
    constant REG_MT_FINE_DELAYS_LT57_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT57_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT57_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT58_ADDR    : std_logic_vector(9 downto 0) := "00" & x"9a";
    constant REG_MT_FINE_DELAYS_LT58_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT58_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT58_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT59_ADDR    : std_logic_vector(9 downto 0) := "00" & x"9b";
    constant REG_MT_FINE_DELAYS_LT59_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT59_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT59_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT60_ADDR    : std_logic_vector(9 downto 0) := "00" & x"9c";
    constant REG_MT_FINE_DELAYS_LT60_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT60_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT60_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT61_ADDR    : std_logic_vector(9 downto 0) := "00" & x"9d";
    constant REG_MT_FINE_DELAYS_LT61_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT61_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT61_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT62_ADDR    : std_logic_vector(9 downto 0) := "00" & x"9e";
    constant REG_MT_FINE_DELAYS_LT62_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT62_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT62_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT63_ADDR    : std_logic_vector(9 downto 0) := "00" & x"9f";
    constant REG_MT_FINE_DELAYS_LT63_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT63_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT63_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT64_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a0";
    constant REG_MT_FINE_DELAYS_LT64_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT64_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT64_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT65_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a1";
    constant REG_MT_FINE_DELAYS_LT65_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT65_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT65_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT66_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a2";
    constant REG_MT_FINE_DELAYS_LT66_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT66_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT66_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT67_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a3";
    constant REG_MT_FINE_DELAYS_LT67_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT67_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT67_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT68_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a4";
    constant REG_MT_FINE_DELAYS_LT68_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT68_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT68_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT69_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a5";
    constant REG_MT_FINE_DELAYS_LT69_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT69_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT69_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT70_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a6";
    constant REG_MT_FINE_DELAYS_LT70_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT70_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT70_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT71_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a7";
    constant REG_MT_FINE_DELAYS_LT71_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT71_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT71_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT72_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a8";
    constant REG_MT_FINE_DELAYS_LT72_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT72_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT72_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT73_ADDR    : std_logic_vector(9 downto 0) := "00" & x"a9";
    constant REG_MT_FINE_DELAYS_LT73_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT73_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT73_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";

    constant REG_MT_FINE_DELAYS_LT74_ADDR    : std_logic_vector(9 downto 0) := "00" & x"aa";
    constant REG_MT_FINE_DELAYS_LT74_MSB    : integer := 4;
    constant REG_MT_FINE_DELAYS_LT74_LSB     : integer := 0;
    constant REG_MT_FINE_DELAYS_LT74_DEFAULT : std_logic_vector(4 downto 0) := '0' & x"0";
    ...
    constant REG_MT_POSNEGS_DSI0_ADDR    : std_logic_vector(9 downto 0) := "01" & x"10";
    constant REG_MT_POSNEGS_DSI0_MSB    : integer := 14;
    constant REG_MT_POSNEGS_DSI0_LSB     : integer := 0;
    constant REG_MT_POSNEGS_DSI0_DEFAULT : std_logic_vector(14 downto 0) := "000" & x"000";

    constant REG_MT_POSNEGS_DSI1_ADDR    : std_logic_vector(9 downto 0) := "01" & x"11";
    constant REG_MT_POSNEGS_DSI1_MSB    : integer := 14;
    constant REG_MT_POSNEGS_DSI1_LSB     : integer := 0;
    constant REG_MT_POSNEGS_DSI1_DEFAULT : std_logic_vector(14 downto 0) := "000" & x"000";

    constant REG_MT_POSNEGS_DSI2_ADDR    : std_logic_vector(9 downto 0) := "01" & x"12";
    constant REG_MT_POSNEGS_DSI2_MSB    : integer := 14;
    constant REG_MT_POSNEGS_DSI2_LSB     : integer := 0;
    constant REG_MT_POSNEGS_DSI2_DEFAULT : std_logic_vector(14 downto 0) := "000" & x"000";

    constant REG_MT_POSNEGS_DSI3_ADDR    : std_logic_vector(9 downto 0) := "01" & x"13";
    constant REG_MT_POSNEGS_DSI3_MSB    : integer := 14;
    constant REG_MT_POSNEGS_DSI3_LSB     : integer := 0;
    constant REG_MT_POSNEGS_DSI3_DEFAULT : std_logic_vector(14 downto 0) := "000" & x"000";

    constant REG_MT_POSNEGS_DSI4_ADDR    : std_logic_vector(9 downto 0) := "01" & x"14";
    constant REG_MT_POSNEGS_DSI4_MSB    : integer := 14;
    constant REG_MT_POSNEGS_DSI4_LSB     : integer := 0;
    constant REG_MT_POSNEGS_DSI4_DEFAULT : std_logic_vector(14 downto 0) := "000" & x"000";
