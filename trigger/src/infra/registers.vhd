...
package registers is
    ...
    constant REG_MT_NUM_REGS : integer := 195;
    ...
    constant REG_FORCE_TRIGGER_PRESCALE_ADDR    : std_logic_vector(9 downto 0) := "00" & x"43";
    constant REG_FORCE_TRIGGER_PRESCALE_MSB    : integer := 31;
    constant REG_FORCE_TRIGGER_PRESCALE_LSB     : integer := 0;
    constant REG_FORCE_TRIGGER_PRESCALE_DEFAULT : std_logic_vector(31 downto 0) := x"ffffffff";

    constant REG_PRESCALE_BYPASS_ADDR    : std_logic_vector(9 downto 0) := "00" & x"44";
    constant REG_PRESCALE_BYPASS_BIT    : integer := 0;
    constant REG_PRESCALE_BYPASS_DEFAULT : std_logic := '1';
    ...
    constant REG_TIU_BUSY_LENGTH_ADDR    : std_logic_vector(9 downto 0) := "01" & x"1f";
    constant REG_TIU_BUSY_LENGTH_MSB    : integer := 31;
    constant REG_TIU_BUSY_LENGTH_LSB     : integer := 0;
    ...
    constant REG_TRIG_CYCLIC_EN_ADDR    : std_logic_vector(9 downto 0) := "10" & x"40";
    constant REG_TRIG_CYCLIC_EN_BIT    : integer := 0;
    constant REG_TRIG_CYCLIC_EN_DEFAULT : std_logic := '0';

    constant REG_TRIG_CYCLIC_INTERVAL_ADDR    : std_logic_vector(9 downto 0) := "10" & x"41";
    ...
    constant REG_LT_LINK_EN0_DEFAULT : std_logic_vector(9 downto 0) := "11" & x"ff";
    ...
    constant REG_LT_LINK_EN1_DEFAULT : std_logic_vector(9 downto 0) := "11" & x"ff";
    ...
    constant REG_LT_LINK_EN2_DEFAULT : std_logic_vector(9 downto 0) := "11" & x"ff";
    ...
    constant REG_LT_LINK_EN3_DEFAULT : std_logic_vector(9 downto 0) := "11" & x"ff";
    ...
    constant REG_LT_LINK_EN4_DEFAULT : std_logic_vector(9 downto 0) := "11" & x"ff";

    constant REG_LT_LINK_AUTOMASK_ADDR    : std_logic_vector(9 downto 0) := "10" & x"47";
    constant REG_LT_LINK_AUTOMASK_BIT    : integer := 0;
    constant REG_LT_LINK_AUTOMASK_DEFAULT : std_logic := '1';

    constant REG_GAPS_TRIG_PRESCALE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"48";
    ...
    constant REG_TRG_LOST_TRIGGER_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"4e";
    constant REG_TRG_LOST_TRIGGER_RATE_MSB    : integer := 23;
    constant REG_TRG_LOST_TRIGGER_RATE_LSB     : integer := 0;

    constant REG_GAPS_TRIGGER_BLOCKED_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"4f";
    constant REG_GAPS_TRIGGER_BLOCKED_RATE_MSB    : integer := 23;
    constant REG_GAPS_TRIGGER_BLOCKED_RATE_LSB     : integer := 0;

    constant REG_TRACK_TRIGGER_BLOCKED_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"50";
    constant REG_TRACK_TRIGGER_BLOCKED_RATE_MSB    : integer := 23;
    constant REG_TRACK_TRIGGER_BLOCKED_RATE_LSB     : integer := 0;

    constant REG_ANY_TRIGGER_BLOCKED_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"51";
    constant REG_ANY_TRIGGER_BLOCKED_RATE_MSB    : integer := 23;
    constant REG_ANY_TRIGGER_BLOCKED_RATE_LSB     : integer := 0;

    constant REG_TRACK_CENTRAL_BLOCKED_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"52";
    constant REG_TRACK_CENTRAL_BLOCKED_RATE_MSB    : integer := 23;
    constant REG_TRACK_CENTRAL_BLOCKED_RATE_LSB     : integer := 0;

    constant REG_TRACK_UMB_CENTRAL_BLOCKED_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"53";
    constant REG_TRACK_UMB_CENTRAL_BLOCKED_RATE_MSB    : integer := 23;
    constant REG_TRACK_UMB_CENTRAL_BLOCKED_RATE_LSB     : integer := 0;

    constant REG_TIU_BUSY_RATE_ADDR    : std_logic_vector(9 downto 0) := "10" & x"54";
    constant REG_TIU_BUSY_RATE_MSB    : integer := 23;
    constant REG_TIU_BUSY_RATE_LSB     : integer := 0;
