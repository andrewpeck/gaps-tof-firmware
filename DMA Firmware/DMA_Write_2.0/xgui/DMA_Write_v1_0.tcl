...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set FIFO [ipgui::add_page $IPINST -name "FIFO"]
  ipgui::add_param $IPINST -name "C_FIFO_WR_DEPTH" -parent ${FIFO}
  ipgui::add_param $IPINST -name "C_FIFO_DATA_SIZE" -parent ${FIFO}

  ipgui::add_param $IPINST -name "address_Complete" -widget comboBox

}

proc update_PARAM_VALUE.C_FIFO_DATA_SIZE { PARAM_VALUE.C_FIFO_DATA_SIZE } {
	# Procedure called to update C_FIFO_DATA_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_FIFO_DATA_SIZE { PARAM_VALUE.C_FIFO_DATA_SIZE } {
	# Procedure called to validate C_FIFO_DATA_SIZE
	return true
}

proc update_PARAM_VALUE.C_FIFO_WR_DEPTH { PARAM_VALUE.C_FIFO_WR_DEPTH } {
	# Procedure called to update C_FIFO_WR_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_FIFO_WR_DEPTH { PARAM_VALUE.C_FIFO_WR_DEPTH } {
	# Procedure called to validate C_FIFO_WR_DEPTH
	return true
}

proc update_PARAM_VALUE.S_AXI_DATA_SIZE { PARAM_VALUE.S_AXI_DATA_SIZE } {
	# Procedure called to update S_AXI_DATA_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.S_AXI_DATA_SIZE { PARAM_VALUE.S_AXI_DATA_SIZE } {
	# Procedure called to validate S_AXI_DATA_SIZE
	return true
}

proc update_PARAM_VALUE.S_AXI_LITE_SIZE { PARAM_VALUE.S_AXI_LITE_SIZE } {
	# Procedure called to update S_AXI_LITE_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.S_AXI_LITE_SIZE { PARAM_VALUE.S_AXI_LITE_SIZE } {
	# Procedure called to validate S_AXI_LITE_SIZE
	return true
}

proc update_PARAM_VALUE.address_Complete { PARAM_VALUE.address_Complete } {
	# Procedure called to update address_Complete when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.address_Complete { PARAM_VALUE.address_Complete } {
	# Procedure called to validate address_Complete
	return true
}
...
proc update_MODELPARAM_VALUE.C_FIFO_WR_DEPTH { MODELPARAM_VALUE.C_FIFO_WR_DEPTH PARAM_VALUE.C_FIFO_WR_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_FIFO_WR_DEPTH}] ${MODELPARAM_VALUE.C_FIFO_WR_DEPTH}
}

proc update_MODELPARAM_VALUE.C_FIFO_DATA_SIZE { MODELPARAM_VALUE.C_FIFO_DATA_SIZE PARAM_VALUE.C_FIFO_DATA_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_FIFO_DATA_SIZE}] ${MODELPARAM_VALUE.C_FIFO_DATA_SIZE}
}

proc update_MODELPARAM_VALUE.S_AXI_DATA_SIZE { MODELPARAM_VALUE.S_AXI_DATA_SIZE PARAM_VALUE.S_AXI_DATA_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.S_AXI_DATA_SIZE}] ${MODELPARAM_VALUE.S_AXI_DATA_SIZE}
}

proc update_MODELPARAM_VALUE.address_Complete { MODELPARAM_VALUE.address_Complete PARAM_VALUE.address_Complete } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.address_Complete}] ${MODELPARAM_VALUE.address_Complete}
}

proc update_MODELPARAM_VALUE.S_AXI_LITE_SIZE { MODELPARAM_VALUE.S_AXI_LITE_SIZE PARAM_VALUE.S_AXI_LITE_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.S_AXI_LITE_SIZE}] ${MODELPARAM_VALUE.S_AXI_LITE_SIZE}
}
