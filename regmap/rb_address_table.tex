...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    SROUT\_POSNEG & \texttt{0x1a} & \texttt{[1:1]} & rw & \texttt{0x1} & 1 to sample on positive edge, 0 on negative \\\hline
    SROUT\_LATENCY & \texttt{0x1a} & \texttt{[6:4]} & rw & \texttt{0x0} & Latency of the SROUT readout \\\hline
    ...
    MT\_TRIGGER\_MODE & \texttt{0x45} & \texttt{[0:0]} & rw & \texttt{0x1} & 1 to use the MT as the source of the trigger \\\hline
