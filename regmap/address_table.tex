...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    RESET & \texttt{0x15} & \texttt{[0:0]} & w & Pulse & Write 1 to completely reset the DRS state machine logic \\\hline
    \end{tabularx}
    \vspace{5mm}
    ...
    CNT\_READOUTS\_COMPLETED & \texttt{0x52} & \texttt{[15:0]} & r & \texttt{} & Number of readouts completed since reset \\\hline
    CNT\_LOST\_EVENT & \texttt{0x53} & \texttt{[31:16]} & r & \texttt{} & Number of trigger lost due to deadtime \\\hline
    CNT\_EVENT & \texttt{0x54} & \texttt{[31:0]} & r & \texttt{} & Number of triggers received \\\hline
    \end{tabularx}
    \vspace{5mm}
    ...
    DATA & \texttt{0x71} & \texttt{[31:0]} & r & \texttt{} & Spy Read Data \\\hline
