...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    PHASE\_SHIFT\_INCDEC & \texttt{0x2d} & \texttt{[0:0]} & rw & \texttt{0x1} & 1 to increment, 0 to decrement \\\hline
    PHASE\_SHIFT\_DONE & \texttt{0x2d} & \texttt{[1:1]} & r & \texttt{} & 1 phase shifting done \\\hline
    \end{tabularx}
    \vspace{5mm}
