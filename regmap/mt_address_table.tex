...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    SSL\_TRIG\_TOP\_BOT\_EN & \texttt{0x1b} & \texttt{[0:0]} & rw & \texttt{0x0} & 1 to enable \\\hline
    SSL\_TRIG\_TOPEDGE\_BOT\_EN & \texttt{0x1b} & \texttt{[1:1]} & rw & \texttt{0x0} & 1 to enable \\\hline
    SSL\_TRIG\_BOTEDGE\_EN & \texttt{0x1b} & \texttt{[2:2]} & rw & \texttt{0x0} & 1 to enable \\\hline
    SSL\_TRIG\_TOPMID\_BOTMID\_EN & \texttt{0x1b} & \texttt{[3:3]} & rw & \texttt{0x0} & 1 to enable \\\hline
    \end{tabularx}
    \vspace{5mm}
