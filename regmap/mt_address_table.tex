...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    RB\_INTEGRATION\_WINDOW & \texttt{0xf} & \texttt{[12:8]} & rw & \texttt{0x1F} & Number of 100MHz clock cycles to integrate the LTB hits to determine which RBs to read out. \\\hline
