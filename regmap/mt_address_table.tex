...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    ANY\_TRIG\_PRESCALE & \texttt{0x40} & \texttt{[31:0]} & rw & \texttt{0xFFFFFFFF} & Prescale value for the ANY trigger. 0 == 0\%, 2**32-1 == 100\% \\\hline
    TRACK\_TRIGGER\_PRESCALE & \texttt{0x41} & \texttt{[31:0]} & rw & \texttt{0xFFFFFFFF} & Prescale value for the Inner + Outer Track Trigger. 0 == 0\%, 2**32-1 == 100\% \\\hline
    \end{tabularx}
    \vspace{5mm}
