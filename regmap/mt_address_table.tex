...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    RB\_INTEGRATION\_WINDOW & \texttt{0xf} & \texttt{[12:8]} & rw & \texttt{0x5} & Number of 100MHz clock cycles to integrate the LTB hits to determine which MTB to read out. \\\hline
    ...
    SSL\_TRIG\_TOP\_BOT\_EN & \texttt{0x19} & \texttt{[0:0]} & rw & \texttt{0x0} & 1 to enable \\\hline
    SSL\_TRIG\_TOPEDGE\_BOT\_EN & \texttt{0x19} & \texttt{[1:1]} & rw & \texttt{0x0} & 1 to enable \\\hline
    SSL\_TRIG\_TOP\_BOTEDGE\_EN & \texttt{0x19} & \texttt{[2:2]} & rw & \texttt{0x0} & 1 to enable \\\hline
    SSL\_TRIG\_TOPMID\_BOTMID\_EN & \texttt{0x19} & \texttt{[3:3]} & rw & \texttt{0x0} & 1 to enable \\\hline
    ...
    \textbf{Node} & \textbf{Adr} & \textbf{Bits} & \textbf{Perm} & \textbf{Def} & \textbf{Description} \\\hline
    \nopagebreak
    ps\_lo & \texttt{0x1100} & \texttt{[31:0]} & rw & \texttt{} & Prescale low byte \\\hline
    ps\_hi & \texttt{0x1101} & \texttt{[31:0]} & rw & \texttt{} & Prescale low byte \\\hline
    ctrl & \texttt{0x1102} & \texttt{[31:0]} & rw & \texttt{} & Control \\\hline
    data & \texttt{0x1103} & \texttt{[31:0]} & rw & \texttt{} & Data \\\hline
    cmd\_stat & \texttt{0x1104} & \texttt{[31:0]} & rw & \texttt{} & Command / status \\\hline
    \end{tabularx}
    \vspace{5mm}
