...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    LT\_LINK\_EN0 & \texttt{0x242} & \texttt{[9:0]} & rw & \texttt{0x0} & DSI 0 RX Link Enable \\\hline
    LT\_LINK\_EN1 & \texttt{0x243} & \texttt{[9:0]} & rw & \texttt{0x0} & DSI 1 RX Link Enable \\\hline
    LT\_LINK\_EN2 & \texttt{0x244} & \texttt{[9:0]} & rw & \texttt{0x0} & DSI 2 RX Link Enable \\\hline
    LT\_LINK\_EN3 & \texttt{0x245} & \texttt{[9:0]} & rw & \texttt{0x0} & DSI 3 RX Link Enable \\\hline
    LT\_LINK\_EN4 & \texttt{0x246} & \texttt{[9:0]} & rw & \texttt{0x0} & DSI 4 RX Link Enable \\\hline
    \end{tabularx}
    \vspace{5mm}
