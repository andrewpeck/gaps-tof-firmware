...
package registers is
    ...
    constant REG_FPGA_RAT_HOUSEKEEPING_ADDR    : std_logic_vector(9 downto 0) := "00" & x"2c";
    constant REG_FPGA_RAT_HOUSEKEEPING_MSB    : integer := 31;
    constant REG_FPGA_RAT_HOUSEKEEPING_LSB     : integer := 0;
    constant REG_FPGA_RAT_HOUSEKEEPING_DEFAULT : std_logic_vector(31 downto 0) := x"00000000";
    ...
    constant REG_CNT_SNAP_ADDR    : std_logic_vector(9 downto 0) := "00" & x"80";
    constant REG_CNT_SNAP_BIT    : integer := 0;

    constant REG_CNT_SNAP_DIS_ADDR    : std_logic_vector(9 downto 0) := "00" & x"80";
    constant REG_CNT_SNAP_DIS_BIT    : integer := 1;
    constant REG_CNT_SNAP_DIS_DEFAULT : std_logic := '1';

    constant REG_CNT_START_READOUT_ADDR    : std_logic_vector(9 downto 0) := "00" & x"81";
    constant REG_CNT_START_READOUT_MSB    : integer := 31;
    constant REG_CNT_START_READOUT_LSB     : integer := 0;

    constant REG_CNT_EVENT_WR_EN_ADDR    : std_logic_vector(9 downto 0) := "00" & x"82";
    constant REG_CNT_EVENT_WR_EN_MSB    : integer := 31;
    constant REG_CNT_EVENT_WR_EN_LSB     : integer := 0;
