...
package registers is
    ...
    constant REG_DRS_NUM_REGS : integer := 61;
    ...
    constant REG_FPGA_PHASE_SHIFT_EN_ADDR    : std_logic_vector(9 downto 0) := "00" & x"2b";
    constant REG_FPGA_PHASE_SHIFT_EN_BIT    : integer := 0;

    constant REG_FPGA_PHASE_SHIFT_CNT_ADDR    : std_logic_vector(9 downto 0) := "00" & x"2c";
    constant REG_FPGA_PHASE_SHIFT_CNT_MSB    : integer := 11;
