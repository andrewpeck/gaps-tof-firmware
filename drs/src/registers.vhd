...
package registers is
    ...
    constant REG_DRS_NUM_REGS : integer := 44;
    constant REG_DRS_ADDRESS_MSB : integer := 8;
    constant REG_DRS_ADDRESS_LSB : integer := 0;
    constant REG_CHIP_DMODE_ADDR    : std_logic_vector(8 downto 0) := '0' & x"00";
    constant REG_CHIP_DMODE_BIT    : integer := 1;
    constant REG_CHIP_DMODE_DEFAULT : std_logic := '1';

    constant REG_CHIP_STANDBY_MODE_ADDR    : std_logic_vector(8 downto 0) := '0' & x"00";
    constant REG_CHIP_STANDBY_MODE_BIT    : integer := 2;
    constant REG_CHIP_STANDBY_MODE_DEFAULT : std_logic := '0';

    constant REG_CHIP_TRANSPARENT_MODE_ADDR    : std_logic_vector(8 downto 0) := '0' & x"00";
    constant REG_CHIP_TRANSPARENT_MODE_BIT    : integer := 3;
    constant REG_CHIP_TRANSPARENT_MODE_DEFAULT : std_logic := '0';

    constant REG_CHIP_DRS_PLL_LOCK_ADDR    : std_logic_vector(8 downto 0) := '0' & x"00";
    constant REG_CHIP_DRS_PLL_LOCK_BIT    : integer := 4;

    constant REG_CHIP_CHANNEL_CONFIG_ADDR    : std_logic_vector(8 downto 0) := '0' & x"00";
    ...
    constant REG_CHIP_DTAP_FREQ_ADDR    : std_logic_vector(8 downto 0) := '0' & x"01";
    constant REG_CHIP_DTAP_FREQ_MSB    : integer := 15;
    constant REG_CHIP_DTAP_FREQ_LSB     : integer := 0;

    constant REG_READOUT_ROI_MODE_ADDR    : std_logic_vector(8 downto 0) := '0' & x"10";
    constant REG_READOUT_ROI_MODE_BIT    : integer := 0;
    constant REG_READOUT_ROI_MODE_DEFAULT : std_logic := '1';

    constant REG_READOUT_BUSY_ADDR    : std_logic_vector(8 downto 0) := '0' & x"10";
    constant REG_READOUT_BUSY_BIT    : integer := 1;

    constant REG_READOUT_ADC_LATENCY_ADDR    : std_logic_vector(8 downto 0) := '0' & x"10";
    ...
    constant REG_READOUT_SAMPLE_COUNT_ADDR    : std_logic_vector(8 downto 0) := '0' & x"10";
    ...
    constant REG_READOUT_EN_SPIKE_REMOVAL_ADDR    : std_logic_vector(8 downto 0) := '0' & x"10";
    constant REG_READOUT_EN_SPIKE_REMOVAL_BIT    : integer := 22;
    constant REG_READOUT_EN_SPIKE_REMOVAL_DEFAULT : std_logic := '1';

    constant REG_READOUT_READOUT_MASK_ADDR    : std_logic_vector(8 downto 0) := '0' & x"11";
    ...
    constant REG_READOUT_AUTO_9TH_CHANNEL_ADDR    : std_logic_vector(8 downto 0) := '0' & x"11";
    constant REG_READOUT_AUTO_9TH_CHANNEL_BIT    : integer := 9;
    constant REG_READOUT_AUTO_9TH_CHANNEL_DEFAULT : std_logic := '1';

    constant REG_READOUT_START_ADDR    : std_logic_vector(8 downto 0) := '0' & x"12";
    constant REG_READOUT_START_BIT    : integer := 0;

    constant REG_READOUT_REINIT_ADDR    : std_logic_vector(8 downto 0) := '0' & x"13";
    constant REG_READOUT_REINIT_BIT    : integer := 0;

    constant REG_READOUT_CONFIGURE_ADDR    : std_logic_vector(8 downto 0) := '0' & x"14";
    constant REG_READOUT_CONFIGURE_BIT    : integer := 0;

    constant REG_READOUT_DRS_RESET_ADDR    : std_logic_vector(8 downto 0) := '0' & x"15";
    constant REG_READOUT_DRS_RESET_BIT    : integer := 0;

    constant REG_READOUT_DAQ_RESET_ADDR    : std_logic_vector(8 downto 0) := '0' & x"16";
    constant REG_READOUT_DAQ_RESET_BIT    : integer := 0;

    constant REG_READOUT_DMA_RESET_ADDR    : std_logic_vector(8 downto 0) := '0' & x"17";
    constant REG_READOUT_DMA_RESET_BIT    : integer := 0;

    constant REG_READOUT_WAIT_VDD_CLKS_ADDR    : std_logic_vector(8 downto 0) := '0' & x"18";
