...
def main():
    ...
    if (len(sys.argv) < 2 and (sys.argv[1] != 'oh' or sys.argv[1] != 'drs')):
        ...
        if sys.argv[1] != 'ctp7' and sys.argv[1] != 'glib' and sys.argv[1] != 'oh' and sys.argv[1] != 'drs':
            print('Unsupported board type. Use "ctp7" or "glib" or "oh" or "drs"')
        else:
            board_type = sys.argv[1]

        if sys.argv[1] != 'oh' and sys.argv[1] != 'drs':
            CONFIG = CONFIG_AMC
            if len(sys.argv) > 2:
            ...
            print('Generating address table for DRS')
            board_type='drs'
            num_of_oh = 0
            CONFIG = CONFIG_DRS
        else:
            print('Generating address table for OH')
            board_type='oh'
            num_of_oh = 0
            CONFIG = CONFIG_OH
